...
$query=mysqli_query($con,"select id from users where id='$adminid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update users set password='$newpassword' where id='$adminid'");
