...
<h3 class="page-header" style="background-color: yellow">
                            <center>Approved skiiedperson list given below You need to select for your business.. </center>
                        </h3>
                        <br>
<div class="row">
<div class="col-lg-12">
...
<form action="" method="post">
            ...
            <thead>
                    <tr>
                        ...
                        <th>Experience</th>
                        <th>Projects Done</th>
                        <th>prefered Location</th><!--address-->
                        <th>Requirment</th>
                        <th>Status</th>
                        <th>Book</th>
...
$query = "SELECT * FROM users WHERE status='approved' and role='skilledperson' ORDER BY registredon DESC";
...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td>$status</td>";
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want Book this Person?')\"href='booking.php'><input type='button' class='btn btn-primary' value='Book Now'></a></td>";
